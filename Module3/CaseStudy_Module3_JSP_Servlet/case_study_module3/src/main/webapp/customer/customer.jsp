...
<nav class="navbar navbar-expand-lg " style="background-color: black">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" style="margin-right: 150px" action="/customerServlet">
    ...
    <div class="row">
        <div class="col-2" style="background-color: lightblue;height: 535px">
            <nav class="nav flex-column" style="padding: 0;margin: 0">
                <a class="nav-link active" href="customer/create_customer.jsp">Create New Customer(+)</a>
            </nav>
        </div>
        <div class="col-10">
            <table class="table table-primary" id="tableCustomer">
                <thead>
                <tr>
                    <th scope="col">Id</th>
                ...
                <c:forEach var="customer" items="${listCustomer}">
                    <tr>
                        ...
                        <td><a href="/customerServlet?action=update&id=${customer.customerId}">
                            <button type="button" class="btn btn-primary">Edit</button>
                        </a>
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#exampleModal${customer.customerId}">
                                Delete
                            </button>
