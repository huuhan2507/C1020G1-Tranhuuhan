...
<nav class="navbar navbar-expand-lg " style="background-color: black">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" style="margin-right: 150px" action="/serviceServlet">
    ...
    <div class="row">
        <div class="col-2" style="background-color: lightblue;height: 535px">
            <nav class="nav flex-column" style="padding: 0;margin: 0">
                <a class="nav-link active" href="service/create_service.jsp">Create New Service(+)</a>
            </nav>
        </div>
        <div class="col-10">
            <table class="table table-primary" id="tableService">
                <thead>
                <tr>
                    <th scope="col">Id</th>
                ...
                <c:forEach var="service" items="${listService}">
                    <tr>
                        ...
                        <td><a href="/serviceServlet?action=update&id=${service.serviceId}">
                            <button type="button" class="btn btn-primary">Edit</button>
                        </a>
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#exampleModal${service.serviceId}">
                                Delete
                            </button>
                            <div class="modal fade" id="exampleModal${service.serviceId}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/serviceServlet?action=delete&id=${service.serviceId}"
                                               style="color: black">
