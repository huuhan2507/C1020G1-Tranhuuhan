...
public class UserRepositoryImpl implements UserRepository {
    ...
    public static final String CALL_LIST_USER = "call list_user";
    ...
    public User searchIdUser(Integer id) {
        User user = new User(  );
        try {
           CallableStatement callableStatement = baseRepository.getConnection().prepareCall( SEARCH_ID_USER );
    ...
    public void creatUserSP(User user) {
        try {
            CallableStatement callableStatement = baseRepository.getConnection().prepareCall( CREAT_USER_SP );
    ...
    public List<User> listeUserSP() {
        ...
        User user = new User(  );
        try {
            CallableStatement callableStatement = baseRepository.getConnection().prepareCall( CALL_LIST_USER );
            ResultSet resultSet = callableStatement.executeQuery();
            while (resultSet.next()){
                user.setId( Integer.parseInt( resultSet.getString( "id" ) ) );
                user.setName( resultSet.getString( "name" ) );
    ...
    public void updateUserSP(Integer id, String name, String email, String country) {
        try {
            CallableStatement callableStatement = baseRepository.getConnection().prepareCall( CALL_UPDATE_USER );
            callableStatement.executeUpdate();
        }catch (SQLException e){
            e.printStackTrace();
        }
    ...
    public void deleteUserSP(Integer id) {
        try {
            CallableStatement callableStatement = baseRepository.getConnection().prepareCall( CALL_DELETE_USER );
            callableStatement.executeUpdate();
        }catch (SQLException e){
            e.printStackTrace();
        }
